...
namespace cpplib {
    ...
    class Storage : public djinni::Storage {
        ...
        using data_set = std::set<djinni::Data, bool (*)(const djinni::Data&, const djinni::Data&)> ;

        data_set store{ [](const djinni::Data& a, const djinni::Data& b) { return a.id < b.id ;} } ;
    ...
    public:
        ...
        int64_t size() const override{
            assert(store.size() < static_cast<std::size_t>(std::numeric_limits<int64_t>::max()));
